...
- [ ] During crisis: priorities suspended, fair-clearing need distribution, emergency research redirection
- [ ] CRISIS_START/CRISIS_END events; replay-safe
- [ ] Tests: lifecycle, suspension effects, equalization
